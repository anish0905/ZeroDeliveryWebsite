  ...
  return (
    <>
      ...
      <Dialog open={open} handler={handleOpen}>
        ...
        <Button   onClick={handleOpen} className="w-6/12 bg-blue-gray-600" >
            <span>Continue</span>
          </Button>
        </div>
        <p className="text-xs text-center mb-4 mt-2">By continuing, you agree to our Terms of service & Privacy policy</p>
