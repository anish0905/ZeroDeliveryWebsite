...
import logo from "../../public/images/reg.jpg";
...
function Register() {
  ...
  const registerUser = async () => {
    try {
      const resp = await axios.post(`${API_URI}/api/admin/register`, {
        email,
        password,
        mobile: mobileNumber,
      });
  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-10 justify-between min-h-screen bg-gray-100 p-4 lg:pt-0 md:pt-0 pt-20">
      <div className="flex justify-center md:justify-end lg:mt-10 md:w-1/2">
